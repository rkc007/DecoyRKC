/*
 * Author : Rahul KC
 * Purpose : This file contains code of client and demonstrates it's protocol while using email based client
...
int main(int argc, char *argv[])
{
    ...
    int len;
    len = snprintf(str, 100, "../webmail/client_email.py 192.168.2.4 192.168.2.4 %s %d", argv[4], resp->port);
    printf("\n%s\n",str);
    system(str);
